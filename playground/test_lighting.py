...
This script:
  1. Compiles examples/lighting_demo.lux -> shadercache/*.spv
  2. Loads the fragment SPIR-V via the fullscreen render harness
  3. Renders a 512x512 frame and saves screenshots/lighting_demo.png
...
FRAG_SPV = SHADERCACHE / "lighting_demo.frag.spv"
OUTPUT_PNG = SCREENSHOTS / "lighting_demo.png"
