...
This script:
  1. Compiles examples/colorspace_demo.lux -> playground/*.spv
  2. Loads the fragment SPIR-V via the fullscreen render harness
  3. Renders a 512x512 frame and saves playground/colorspace_demo.png
...
FRAG_SPV = PLAYGROUND_DIR / "colorspace_demo.frag.spv"
OUTPUT_PNG = PLAYGROUND_DIR / "colorspace_demo.png"
