...
This script:
  1. Compiles examples/ibl_demo.lux -> shadercache/*.spv
  2. Loads the fragment SPIR-V via the fullscreen render harness
  3. Renders a 512x512 frame and saves screenshots/ibl_demo.png
...
FRAG_SPV = SHADERCACHE / "ibl_demo.frag.spv"
OUTPUT_PNG = SCREENSHOTS / "ibl_demo.png"
