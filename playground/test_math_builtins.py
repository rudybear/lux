...
This script:
  1. Compiles examples/math_builtins_demo.lux -> shadercache/*.spv
  2. Loads the fragment SPIR-V via the fullscreen render harness
  3. Renders a 512x512 frame and saves screenshots/math_builtins_demo.png
...
FRAG_SPV = SHADERCACHE / "math_builtins_demo.frag.spv"
OUTPUT_PNG = SCREENSHOTS / "math_builtins_demo.png"
