...
if exist playground_cpp\build\Release\lux-playground.exe (
    ...
    playground_cpp\build\Release\lux-playground.exe --scene assets/DamagedHelmet.glb --pipeline shadercache/gltf_pbr_layered+emission+normal_map --mode rt --output screenshots/test_gltf_layered_rt_cpp.png --width 512 --height 512
    echo.
) else (
...
if exist playground_rust\target\release\lux-playground.exe (
    ...
    playground_rust\target\release\lux-playground.exe --scene assets/DamagedHelmet.glb --pipeline shadercache/gltf_pbr_layered+emission+normal_map --mode rt --output screenshots/test_gltf_layered_rt_rust.png --width 512 --height 512
    echo.
) else (
