...
fn main_1() {
    let _e16 = position_1;
    let _e20 = vec4<f32>(_e16.x, _e16.y, _e16.z, 1f);
    let _e22 = global.model;
    world_pos = (_e22 * _e20).xyz;
    let _e26 = global.model;
    let _e27 = normal_1;
    world_normal = normalize((_e26 * vec4<f32>(_e27.x, _e27.y, _e27.z, 0f)).xyz);
    let _e35 = uv_1;
    frag_uv = _e35;
    let _e37 = global.projection;
    let _e39 = global.view;
    let _e42 = global.model;
    unnamed.gl_Position = (((_e37 * _e39) * _e42) * _e20);
    return;
}
